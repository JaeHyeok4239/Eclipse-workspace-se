...
public class HashSetMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("# set size:"+carSet.size());
		isAdd = carSet.add(car5);
		System.out.println(">>추가성공여부 : "+isAdd);
		System.out.println("# set size:"+carSet.size());
		System.out.println(carSet);
		System.out.println("--------- 2. add[중복] -----------");
		/*
		 Element 의 hashCode와 equals 메쏘드호출해서 중복을체크한다. 
		 */
		Car duplicateCar=new Car("5555",5);
		...
		boolean isRemove = carSet.remove(car3);
		System.out.println(">> 삭제여부 :" + isRemove);
		System.out.println("# set size :" + carSet.size());
		isRemove = carSet.remove(new Car("2222",2));
		System.out.println(">> 삭제여부 :" + isRemove);
		System.out.println("# set size :" + carSet.size());
