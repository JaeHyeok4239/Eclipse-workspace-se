...
class Child extends Parent{
	...
	//부모로부터상속받은 method2()는 은폐되어서 외부(내부)에서 호출불가능
	public void method2() {
		System.out.println("Parent.method2()");
	}
	 */
	...
	public void method2() {
		...
		System.out.println("Parent.method2()를 Child에서 재정의");
		/*
		 * super
		 *   - this와 같은 self참조변수이다.
		 *   - this와 같은 주소를 가리킨다.
		 *   - 재정의에의해 은폐된 메쏘드 호출시사용
		 */
		super.method2();
		System.out.println("Child.method2() 추가작업");
		System.out.println("-------재정의한 method2 end  ------");
	}
	public void method3() {
